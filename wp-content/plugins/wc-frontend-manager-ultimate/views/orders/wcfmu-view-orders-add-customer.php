...
<form id="wcfm_order_add_customer_form" class="wcfm_popup_wrapper">
    ...
    <table>
        <tbody>
            <tr>
                <td>
                    <p class="wcfm_order_add_customer_form_label wcfm_popup_label"><?php _e('Username', 'wc-frontend-manager'); ?> <span class="required">*</span></p>
                    <input type="text" class="wcfm_popup_input" name="wcbc_user_name" value="" />
                </td>
            </tr>
            <tr>
                <td>

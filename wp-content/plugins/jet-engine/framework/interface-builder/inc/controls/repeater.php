...
if ( ! class_exists( 'CX_Control_Repeater' ) ) {
	...
	class CX_Control_Repeater extends CX_Controls_Base {
		...
		public function init() {
			...
			add_action( 'wp_footer', array( $this, 'print_js_template' ), 0 );
		...
		public function render_row( $index, $widget_index, $data ) {
			...
			$html .= '<a href="#" class="cx-ui-repeater-remove">';
				...
				$html .= '<div class="cx-tooltip">Esta seguro?<br><span class="cx-ui-repeater-remove__confirm">Si</span> / <span class="cx-ui-repeater-remove__cancel">No</span></div>';
			$html .='</a>';

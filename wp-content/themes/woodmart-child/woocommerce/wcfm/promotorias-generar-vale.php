 ...
 */
global $wp, $wpdb;
$vendor_id = $wp->query_vars['wcfm-promotorias-generar-vale'];
...
<div class="collapse wcfm-collapse">
    ...
    <div class="wcfm-collapse-content">
        ...
        <div class="wcfm-container">
            <div id="wcfm-promotorias-generar-vale" class="wcfm-content text-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form action="" method="post">
                                <table class="display dataTable dtr-inline collapsed">
                                    <thead>
                                        <tr>
                                            <th colspan="5" class="text-center">
                                                Comisiones pendientes de <?= $store_name ?>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>Código</th>
                                        ...
                                        <?php if (empty($wcfm_affiliate_orders_array)) { ?>
                                            ...
                                            foreach ($wcfm_affiliate_orders_array as $wcfm_affiliate_order_single) {
                                                ...
                                                if ($wcfm_affiliate_order_single->commission_type == 'vendor') {
                                                    $commission_type_text = __('Vendor Register', 'wc-frontend-manager-affiliate');
                                                } else if ($wcfm_affiliate_order_single->commission_type == 'vendor_order') {
                                                    $commission_type_text = __('Vendor Order', 'wc-frontend-manager-affiliate');
                                                } else {
                                                    $commission_type_text = __('Order', 'wc-frontend-manager-affiliate');
                                                }
                                            ?>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><?= wc_price($wcfm_affiliate_order_single->commission_amount) ?></td>
                                                    <td><span class="badge"><?= $commission_type_text ?></span></td>
                                                    <td>
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <div class="info-box-inner set-cont-mb-s reset-last-child">
                                                <p class="wd-fontsize-m">
                                                    VALE DE <strong><?= wc_price($coupon_for_affiliate->get_amount()) ?></strong> para productos
                                                    de <?= $store_name ?>
                                                </p>
                                            </div>
